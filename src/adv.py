...
current_player = Player("Jason", 42, room['outside'])

while True:
    print()
    print(f'Your current location is {current_player.current_room.name}')
    print()
    print(f'\n{current_player.current_room.description}')
    print()
    direction = input(f'Please choose a direction: ')
    print()
    if direction.lower() == "n":
        ...
        print()
        print(f'{current_player.name}, thanks for playing.')
        break
    else:
        print()
